...
<body>
                ...
                <div class="card-side-suhu">
                    <div class="d-flex justify-content-between">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            ?>
                                <li><a class="dropdown-item" href="control2.php?ruang=<?php echo $rowKelas['nama_kelas'] ?>"><?php echo $rowKelas['nama_kelas'] ?></a></li>
                            <?php
                            }
                            ?>
                        </ul>
                    ...
                    <div class="control-nav">
                        <div class="mt-5 control-nav-items">
                            <a class="ctr-biasa" href="control.php?ruang=<?php echo $ruang ?>">
                                <i class="ri-temp-hot-line"></i>
                            </a>
                        </div>
                        <div class="control-nav-items ctr-act">
                            <a class="ctr-warna-act" href="control2.php?ruang=<?php echo $ruang ?>">
                    ...
                    <li class="d-flex side-card-items mt-5">
                        <img src="assets/img/lampu-icon.png" alt="suhu">
                        <div class="text-suhu">
                            <span>Lampu 1</span>
                            <div class="d-flex">
    ...
    <div class="toast align-items-center text-white bg-primary border-0" id="EpicToast" role="alert" aria-live="assertive" aria-atomic="true" style="position: absolute; top: 25px; right: 10px;">
        <div class="d-flex">
            <div class="toast-body" style="font-size: 2vw;" id="toastText">
