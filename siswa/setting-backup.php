            ...
            <div class="main-side mts-4">
                ...
                <div class="card-moni-utama">
                    <div class="d-flex">
                        ...
                        <span style="margin-top: -0.3vw; font-size: 1vw; font-weight:600;">Pengaturan Akun</span>
                    </div>
                    <form action="setting-aksi-backup.php" method="POST">
                        <?php
                        while ($fetch = mysqli_fetch_array($select)) { ?>
                            <div class="col-md-6">
                                <label for="inputUsername" class="form-label">Nama Pengguna</label>
                                <input type="text" name="username" class="form-control bg-grey" id="inputUsername" value="<?php echo "$fetch[fullname]"; ?>">
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <label for="password" class="form-label mb-3">Kata Sandi Baru</label>
                                <input type="password" name="passwordBaru" id="password" oninput="strengthChecker()" maxlength="55" class="form-control bg-grey" placeholder="Masukan kata sandi">
                            ...
                            <div class="col-md-6">
                                <label for="password" class="form-label mb-3">Konfirmasi Kata Sandi Baru</label>
                                <input type="password" name="passwordConfirm" id="password" oninput="strengthChecker()" maxlength="55" class="form-control bg-grey" placeholder="Masukan kata sandi">
                                <span id="toggle" onclick="toggle()">
                                    <i class="fas fa-eye"></i>
                                </span>
                                <div id="strength-bar"></div>
                            ...
                            <div class="col-md-6">
                                <label for="password" class="form-label mb-3">Kata Sandi Lama</label>
                                <input type="password" name="passwordLama" id="password" oninput="strengthChecker()" maxlength="55" class="form-control bg-grey" placeholder="Masukan kata sandi">
                                <span id="toggle" onclick="toggle()">
                                    <i class="fas fa-eye"></i>
                                </span>
                                <p id="msg"></p>
                            ...
                            <div class="col-md-12">
                                <button type="submit" name="Ganti" value="Ganti" class="btn-1">Simpan</button>
                            </div>
                </div>
                </form>
            <?php } ?>
