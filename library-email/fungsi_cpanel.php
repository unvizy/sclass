...
function smtp_mail($to, $subject, $message, $from_name, $from, $cc, $bcc, $debug = false)
{
  ...
  $mail->Username   = 'HSTKI2021@gmail.com';                // Masukkan Email yang digunakan selama proses pengiriman email via SMTP
  $mail->Password   = 'hstkitasik123';                              // Masukkan Password dari Email tsb
  $default_email_from       = 'HSTKI2021@gmail.com';        // Masukkan default from pada email
  $default_email_from_name  = 'Admin SCLASS';           // Masukkan default nama dari from pada email
